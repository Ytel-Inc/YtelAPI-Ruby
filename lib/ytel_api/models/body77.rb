...
module YtelApi
  ...
  class Body77 < BaseModel
    ...
    # Please enter multiple E164 number. You can add max 10 numbers. Add numbers
    ...
    # Define the DTMF that the called party should send to bridge the call.
    # Allowed Values : 0-9, #, *
    # @return [String]
    attr_accessor :group_confirm_key

    # Specify the audio file you want to play when the called party picks up the
    # call
    # @return [GroupConfirmFileEnum]
    attr_accessor :group_confirm_file
    ...
    # elapsed time and pass other general information.
    # @return [String]
    ...
    # Time (in seconds) we should wait while the call is ringing before
    # canceling the call
    # @return [Integer]
    ...
    def self.names
      ...
      @_hash['to'] = 'To'
      @_hash['url'] = 'Url'
      @_hash['group_confirm_key'] = 'GroupConfirmKey'
      @_hash['group_confirm_file'] = 'GroupConfirmFile'
      @_hash['method'] = 'Method'
    ...
    def initialize(from = nil,
                   to = nil,
                   url = nil,
                   group_confirm_key = nil,
                   group_confirm_file = nil,
                   method = nil,
      ...
      @to = to
      @url = url
      @group_confirm_key = group_confirm_key
      @group_confirm_file = group_confirm_file
      @method = method
    ...
    def self.from_hash(hash)
      ...
      to = hash['To']
      url = hash['Url']
      group_confirm_key = hash['GroupConfirmKey']
      group_confirm_file = hash['GroupConfirmFile']
      method = hash['Method']
