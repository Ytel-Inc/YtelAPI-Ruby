...
module YtelApi
  ...
  class YtelApiClient
    ...
    # Singleton access to dedicated_short_code controller.
    # @return [DedicatedShortCodeController] Returns the controller instance.
    def dedicated_short_code
      DedicatedShortCodeController.instance
    end
