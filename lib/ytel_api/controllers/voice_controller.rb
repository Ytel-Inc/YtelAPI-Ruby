...
module YtelApi
  ...
  class VoiceController < BaseController
    ...
    # voice call.
    # @return String response from the API call
    def create_view_call_details(call_sid)
      # Prepare query url.
      _query_builder = Configuration.base_uri.dup
    ...
    # above Url parameter
    # @param [Status1Enum] status Optional parameter: Status to set the
    # in-progress call to
    # @return String response from the API call
    ...
    # audio play back
    # @param [Direction1Enum] direction Optional parameter: The leg of the call
